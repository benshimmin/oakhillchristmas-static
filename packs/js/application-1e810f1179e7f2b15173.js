...
document.addEventListener("DOMContentLoaded", function () {
  var muted = true;
  var toggle = document.querySelector(".icon-sound-toggle");
  toggle && toggle.addEventListener("click", function (event) {
    document.querySelector("video").muted = muted = !muted;
    event.currentTarget.classList.toggle("toggled", !muted);
  });
  document.querySelectorAll(".icon-scroll-down").forEach(function (element) {
    element.addEventListener("click", function (event) {
      var oTop = document.querySelector("#more").offsetTop - 130;
